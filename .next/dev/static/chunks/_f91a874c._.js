...
"[project]/components/users/edit/file-upload.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function FileUpload({ documents, onDocumentsChange, onPreview, category }) {
    _s();
    ...
    const simulateUpload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FileUpload.useCallback[simulateUpload]": (file)=>{
            const uploadingFile = {
                name: file.name,
                state: "uploading"
            };
            setUploadingFiles({
                "FileUpload.useCallback[simulateUpload]": (prev)=>[
                        ...prev,
                        uploadingFile
                    ]
            }["FileUpload.useCallback[simulateUpload]"]);
            // Simulate upload progress
            setTimeout({
                "FileUpload.useCallback[simulateUpload]": ()=>{
                    setUploadingFiles({
                        "FileUpload.useCallback[simulateUpload]": (prev)=>prev.map({
                                "FileUpload.useCallback[simulateUpload]": (f)=>f.name === file.name ? {
                                        ...f,
                                        state: "success"
                                    } : f
                            }["FileUpload.useCallback[simulateUpload]"])
                    ...
                    setTimeout({
                        "FileUpload.useCallback[simulateUpload]": ()=>{
                            ...
                            setUploadingFiles({
                                "FileUpload.useCallback[simulateUpload]": (prev)=>prev.filter({
                                        "FileUpload.useCallback[simulateUpload]": (f)=>f.name !== file.name
                                    }["FileUpload.useCallback[simulateUpload]"])
                            }["FileUpload.useCallback[simulateUpload]"]);
                        }
                    }["FileUpload.useCallback[simulateUpload]"], 1000);
                }
            }["FileUpload.useCallback[simulateUpload]"], 1500);
        }
    }["FileUpload.useCallback[simulateUpload]"], [
        documents,
        onDocumentsChange,
    ...
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FileUpload.useCallback[handleDelete]": (docId)=>{
            onDocumentsChange(documents.filter({
                "FileUpload.useCallback[handleDelete]": (d)=>d.id !== docId
            }["FileUpload.useCallback[handleDelete]"]));
        }
    }["FileUpload.useCallback[handleDelete]"], [
        documents,
        onDocumentsChange
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
          ...
          ${isDragging ? "border-blue-500 border-dashed bg-blue-50/50 dark:bg-blue-950/30" : "border-border border-dashed hover:border-border/80"}
        `,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        fileName: "[project]/components/users/edit/file-upload.tsx",
                        lineNumber: 128,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            uploadingFiles.map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "border border-border rounded-xl p-4",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center gap-3",
                        children: [
                            file.state === "uploading" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                            ...
                            file.state === "success" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: file.state === "uploading" ? "Загрузка файла..." : "Документ загружен"
                                    }, void 0, false, {
                                        fileName: "[project]/components/users/edit/file-upload.tsx",
                                        lineNumber: 156,
                                        columnNumber: 15
            ...
            filteredDocs.map((doc)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "border border-border rounded-xl p-4",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(FileUpload, "oySRor0GRoQKyNLL2etlEFNmQeQ=");
_c = FileUpload;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$users$2f$edit$2f$file$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/users/edit/file-upload.tsx [app-client] (ecmascript)");
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$users$2f$edit$2f$file$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileUpload"], {
                                                                documents: documents.filter((d)=>d.category === "passport"),
                                                                onDocumentsChange: (docs)=>{
                                                                    const otherDocs = documents.filter((d)=>d.category !== "passport");
                                                                    setDocuments([
                                                                        ...otherDocs,
                                                                        ...docs
                                                                    ]);
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$users$2f$edit$2f$file$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FileUpload"], {
                                                                ...
                                                                onDocumentsChange: (docs)=>{
                                                                    const passportDocs = documents.filter((d)=>d.category !== "other");
                                                                    setDocuments([
                                                                        ...passportDocs,
                                                                        ...docs
                                                                    ]);
...
_s(UserEditProfile, "B/lqAJRQ0fm2728mv+favcMxs24=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_f91a874c._.js.map