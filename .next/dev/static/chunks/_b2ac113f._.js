...
;
;
// Список популярных стран с кодами
const COUNTRIES = [
    {
        code: "RU",
        dialCode: "+7",
...
function PhoneInput({ value = "", onChange, defaultCountry = "RU", className, ...props }) {
    ...
    // Определяем код страны из значения
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
            ...
            if (value) {
                ...
                const detectedCountry = sortedCountries.find({
                    "PhoneInput.useEffect.detectedCountry": (country)=>{
                        ...
                        return valueDigits.startsWith(countryDigits);
                    }
    ...
    const formatPhoneNumber = (allDigits)=>{
        ...
        if (allDigits.startsWith(countryDigits)) {
            ...
            // Если не начинается с кода страны, возвращаем как есть
            return `+${allDigits}`;
        }
        ...
        if (selectedCountry.code === "RU" || selectedCountry.code === "KZ") {
            ...
            if (numberPart.length <= 6) {
                return `${selectedCountry.dialCode} (${numberPart.slice(0, 3)}) ${numberPart.slice(3)}`;
            }
            if (numberPart.length <= 8) {
                return `${selectedCountry.dialCode} (${numberPart.slice(0, 3)}) ${numberPart.slice(3, 6)}-${numberPart.slice(6)}`;
            }
            return `${selectedCountry.dialCode} (${numberPart.slice(0, 3)}) ${numberPart.slice(3, 6)}-${numberPart.slice(6, 8)}-${numberPart.slice(8, 10)}`;
        } else if (selectedCountry.code === "BY") {
            // +375 (99) 999-99-99
            if (numberPart.length <= 2) {
                return `${selectedCountry.dialCode} (${numberPart}`;
            }
            if (numberPart.length <= 5) {
                return `${selectedCountry.dialCode} (${numberPart.slice(0, 2)}) ${numberPart.slice(2)}`;
            }
            if (numberPart.length <= 7) {
                return `${selectedCountry.dialCode} (${numberPart.slice(0, 2)}) ${numberPart.slice(2, 5)}-${numberPart.slice(5)}`;
            }
            return `${selectedCountry.dialCode} (${numberPart.slice(0, 2)}) ${numberPart.slice(2, 5)}-${numberPart.slice(5, 7)}-${numberPart.slice(7, 9)}`;
            ...
            return `${selectedCountry.dialCode} (${numberPart.slice(0, 3)}) ${numberPart.slice(3, 6)}-${numberPart.slice(6, 10)}`;
        } else if (selectedCountry.code === "GB") {
            // +44 9999 999999
            if (numberPart.length <= 4) {
                return `${selectedCountry.dialCode} ${numberPart}`;
            }
            return `${selectedCountry.dialCode} ${numberPart.slice(0, 4)} ${numberPart.slice(4, 10)}`;
        }
        // По умолчанию просто добавляем код страны
        return numberPart ? `${selectedCountry.dialCode} ${numberPart}` : selectedCountry.dialCode;
    };
    const handleChange = (e)=>{
        const input = e.target.value;
        const digits = input.replace(/\D/g, "");
        // Автоопределение страны по коду (проверяем начало номера)
        if (digits.length > 0) {
            // Сортируем страны по длине кода (от большего к меньшему) для правильного определения
            const sortedCountries = [
                ...COUNTRIES
        ...
        // Ограничиваем длину номера (максимум 15 цифр согласно E.164)
        const maxDigits = 15;
    ...
    const displayValue = value || selectedCountry.dialCode;
...
const ProfileSection = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(({ id, icon: Icon, title, children, headerAction }, ref)=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: ref,
        id: id,
        className: "bg-white dark:bg-card border border-gray-200 dark:border-border rounded-[10px] p-6 shadow-sm scroll-mt-24",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function MyProfile() {
    ...
    const sectionRefs = {
        ...
        appearance: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null)
    };
    // Personal data
    ...
    // Email change
    const [emailData, setEmailData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    // Получаем текущую тему для отображения (с учетом system)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "max-w-[1200px] mx-auto px-8 py-6",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-8",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$phone$2d$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PhoneInput"], {
                                                                            ...
                                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-full", personalDataErrors.phone && "border-destructive"),
...
_s(MyProfile, "pNkCEf2fC0nw30oBjLn2uYnXqX8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
...
//# sourceMappingURL=_b2ac113f._.js.map