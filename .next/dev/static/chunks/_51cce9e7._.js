...
function UserEditProfile({ user }) {
    ...
    const hasAnyChanges = ()=>{
        return hasPersonalDataChanges() || hasPassportDataChanges() || hasOtherDataChanges() || hasBankDataChanges() || hasSystemDataChanges();
    };
    const handleSave = ()=>{
        if (!hasAnyChanges()) {
            toast({
...
_s(UserEditProfile, "OyfxBlCa9gx8wzpIhEACwGAJriw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_51cce9e7._.js.map