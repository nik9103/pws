...
import type { CompetitionFilterState } from "@/types/competition"
import { filterOptions, getCompetitionCounts } from "@/lib/mock-competitions"

interface CompetitionFiltersProps {
  filters: CompetitionFilterState
  onFiltersChange: (filters: CompetitionFilterState) => void
  totalCompetitions: number
}

type FilterCategory = "disciplines" | "statuses"

export function CompetitionFilters({ filters, onFiltersChange, totalCompetitions }: CompetitionFiltersProps) {
  ...
  const competitionCounts = getCompetitionCounts()
